...
INSERT INTO `broadcastchannel` (`channel_id`, `channel_name`) VALUES (1,'Star Sports 1'),(2,'Star Sports 2'),(3,'Star Sports 3'),(4,'Star Sports 1 HD'),(5,'Star Sports 2 HD'),(6,'Hotstar'),(7,'Star Sports Hindi 3');
...
INSERT INTO `orangecap` (`player_id`, `player_name`, `runs`) VALUES (146,'Shikhar Dhawan',121635),(128,'Rohit Sharma',102321),(2,'Manan Vohra',100000),(11,'Jaydev Unadkat',99900),(51,'Chris Gayle',96504);
...
INSERT INTO `purplecap` (`player_id`, `player_name`, `wickets`) VALUES (130,'Jasprit Bumrah',49),(118,'Rituraj Gaikwad',42),(136,'Jayant Yadav',42),(154,'Ishant Sharma',40),(135,'Anmolpreet singh',36);
...
INSERT INTO `team` (`team_id`, `team_name`, `no_of_players`, `owner_id`, `captain_id`, `matches_won`, `matches_lost`, `matches_draw`, `points_tournament`, `points_fairplay`) VALUES (1,'KKR',22,1,74,4,5,0,8,0),(2,'RCB',22,2,91,3,6,1,6,0),(3,'CSK',21,3,110,5,4,0,10,0),(4,'KXIP',25,4,45,7,2,0,14,0),(5,'RR',23,5,2,8,1,0,16,0),(6,'DD',20,6,31,1,8,0,2,0),(7,'MI',21,7,128,9,0,0,18,0),(8,'DC',21,8,146,4,5,0,8,0),(9,'KTR',20,9,151,6,3,0,12,0),(10,'PW',18,10,154,8,2,0,16,0),(11,'SRH',18,11,164,9,0,0,18,0),(12,'RPS',18,12,159,3,6,0,6,0),(13,'GL',20,20,173,2,7,0,4,0);
...
-- Dump completed on 2020-04-30 11:49:45
