...
class admin(FlaskForm):
	choice = RadioField('Select Operation', choices=[('1','INSERT'),('2','UPDATE'),('3','DELETE')],validators=[DataRequired()] , default='1')
	db = RadioField('Select Database', choices=[('1','MATCHES'),('2','OfficialsForMatches'),('3','AUCTION'),('4','UMPIRES'),('5','PLAYERS'),('6','TEAMS'),('7','OWNERS'),('8','MANAGERS'),('9','GROUNDS'),('10','HOMEGROUND'),('11','SPONSORS'),('12','BROADCASTERS'),('13','COMMENTATORS'),('14',"COMMENTATORS FOR MATCH")],validators=[DataRequired()], default='1')

class CricketGroundCommittee(FlaskForm):
	choice = RadioField('Select Operation', choices=[('1','INSERT'),('2','UPDATE'),('3','DELETE')],validators=[DataRequired()], default='1')
	db = RadioField('Select Database', choices=[('9','GROUNDS'),('10','HOMEGROUND')],validators=[DataRequired()], default='1')

class AuctionCommittee(FlaskForm):
	choice = RadioField('Select Operation', choices=[('1','INSERT'),('2','UPDATE'),('3','DELETE')],validators=[DataRequired()], default='1')
	db = RadioField('Select Database', choices=[('3','AUCTION'),('5','PLAYERS'),('6','TEAMS')],validators=[DataRequired()], default='1')

class PlayerBoard(FlaskForm):
	choice = RadioField('Select Operation', choices=[('1','INSERT'),('2','UPDATE'),('3','DELETE')],validators=[DataRequired()], default='1')
	db = RadioField('Select Database', choices=[('5','PLAYERS')],validators=[DataRequired()], default='1')

class Manager(FlaskForm):
	choice = RadioField('Select Operation', choices=[('1','INSERT'),('2','UPDATE'),('3','DELETE')],validators=[DataRequired()], default='1')
	db = RadioField('Select Database', choices=[('6','TEAMS')],validators=[DataRequired()], default='1')
...
class PLAYERS_insert(FlaskForm):
	...
	Nationality = StringField('Nation', validators=[DataRequired()])
...
class COMMENTATORS_insert(FlaskForm):
	...
	available = StringField('Available (Enter 1/0)', validators=[DataRequired()])
...
class COMMENTATORSFORMATCH_insert(FlaskForm):
	...
	channel_id = IntegerField('Channel No.', validators=[DataRequired()])
