...
INSERT INTO `broadcastchannel` VALUES (1,'Star Sports 1'),(2,'Star Sports 2'),(3,'Star Sports 3'),(4,'Star Sports 1 HD'),(5,'Star Sports 2 HD'),(6,'Hotstar'),(7,'Star Sports Hindi 3');
...
INSERT INTO `commentators` VALUES (1,'Cody',1,3),(2,'Marco',1,1),(3,'Gregorius',1,2),(4,'Buddy',1,2),(5,'Lauritz',0,5),(6,'Kissiah',0,5),(7,'Tabbi',0,4),(8,'Tatum',0,1),(9,'Arther',0,2),(10,'Candis',0,2),(11,'Darb',1,3),(12,'Parker',1,4),(13,'Karyn',0,4),(14,'Row',0,5),(15,'Arielle',1,1);
...
INSERT INTO `cricketgrounds` VALUES (1,'Wankhede Stadium','Mumbai'),(2,'IS Bindra Stadium','Mohali'),(3,'Eden Gardens','Kolkata'),(4,'Rajiv Gandhi Intl. Cricket Stadium','Hyderabad'),(5,'M. A. Chidambaram Stadium','Chennai'),(6,'Sawai Mansingh Stadium','Jaipur'),(7,'M. Chinnaswamy Stadium','Bengaluru'),(8,'Feroz Shah Kotla Ground','Delhi'),(9,'Holkar Cricket Stadium','Indore'),(10,'Khel Gao','Rajasthan');
...
INSERT INTO `homeground` VALUES (1,3),(2,8),(3,1),(4,6),(5,1),(6,2),(7,9),(8,3),(9,3),(10,1),(11,2),(12,1),(13,8);
...
CREATE TABLE `matches` (
  ...
  KEY `index3` (`stadium_id`),
  CONSTRAINT `chk_stadium_id` CHECK ((`stadium_id` > 0))
...
CREATE TABLE `officials` (
  ...
  CONSTRAINT `chk_designation` CHECK ((`designation` > 0)),
  CONSTRAINT `chk_salary_per_match` CHECK ((`salary_per_match` > 0))
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `orangecap` VALUES (146,'Shikhar Dhawan',121635),(128,'Rohit Sharma',102321),(2,'Manan Vohra',100000),(11,'Jaydev Unadkat',99900),(51,'Chris Gayle',96504);
...
CREATE TABLE `owners` (
  ...
  CONSTRAINT `chk_ownership_stake` CHECK (((`ownership_stake` > 0) and (`ownership_stake` < 101)))
...
CREATE TABLE `player` (
  ...
  KEY `index5` (`team_name`,`team_id`),
  CONSTRAINT `chk_player_salary_per_match` CHECK ((`salary_per_match` > 0)),
  CONSTRAINT `chk_player_total_runs` CHECK ((`total_runs` >= 0)),
  CONSTRAINT `chk_player_total_wickets` CHECK ((`total_wickets` >= 0))
...
INSERT INTO `purplecap` VALUES (130,'Jasprit Bumrah',49),(118,'Rituraj Gaikwad',42),(136,'Jayant Yadav',42),(154,'Ishant Sharma',40),(135,'Anmolpreet singh',36);
...
CREATE TABLE `sponsors` (
  ...
  CONSTRAINT `chk_sponsorship_scale` CHECK (((`sponsorship_scale` > 0) and (`sponsorship_scale` < 101)))
...
CREATE TABLE `team` (
  ...
  CONSTRAINT `chk_matches_draw` CHECK ((`matches_draw` >= 0)),
  CONSTRAINT `chk_matches_lost` CHECK ((`matches_lost` >= 0)),
  CONSTRAINT `chk_matches_won` CHECK ((`matches_won` >= 0)),
  CONSTRAINT `chk_no_of_players` CHECK ((`no_of_players` >= 0))
...
INSERT INTO `team` VALUES (1,'KKR',22,1,74,4,5,0,8,0),(2,'RCB',22,2,91,3,6,1,6,0),(3,'CSK',21,3,110,5,4,0,10,0),(4,'KXIP',25,4,45,7,2,0,14,0),(5,'RR',23,5,2,8,1,0,16,0),(6,'DD',20,6,31,1,8,0,2,0),(7,'MI',21,7,128,9,0,0,18,0),(8,'DC',21,8,146,4,5,0,8,0),(9,'KTR',20,9,151,6,3,0,12,0),(10,'PW',18,10,154,8,2,0,16,0),(11,'SRH',18,11,164,9,0,0,18,0),(12,'RPS',18,12,159,3,6,0,6,0),(13,'GL',20,22,173,2,7,0,4,0);
...
--
-- Dumping events for database 'ipl3'
--
/*!50106 SET @save_time_zone= @@TIME_ZONE */ ;
/*!50106 DROP EVENT IF EXISTS `updLeads` */;
DELIMITER ;;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;;
...
/*!50106 CREATE*/ /*!50117 DEFINER=`DBMS`@`localhost`*/ /*!50106 EVENT `updLeads` ON SCHEDULE EVERY 1 MINUTE STARTS '2020-04-30 11:46:19' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
    DELETE FROM purplecap;
   INSERT INTO purplecap
   SELECT player_id, player_name, total_wickets FROM player ORDER BY total_wickets DESC LIMIT 5;
    DELETE FROM orangecap;
    INSERT INTO orangecap
   SELECT player_id, player_name, total_runs FROM player ORDER BY total_runs DESC LIMIT 5;
END */ ;;
...
-- Dump completed on 2020-04-30 17:17:07
